...
const InStockProducts = ({ value, inStockProducts, setInStockProducts, setCurrentRowData, setOpenEdit }) => {
    ...
    function fetchProducts() {
        axios.get(`${API_ROOT}/product/instock?page=${page}`).then((res) => {
            setInStockProducts(res?.data?.products);
