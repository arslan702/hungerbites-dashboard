...
const TABLE_HEAD = [
    ...
    { id: 'category', label: 'Restaurant', alignRight: false, isUser: true },
            ...
            >
                <TableBody className={classes.tableBody}>
                    {productsList?.map((row) => {
                        const { id, name, Restaurant,  available, price, updatedAt } = row;
                        ...
                        return (
                            <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedRow} className={classes.root}>
                                ...
                                <TableCell align="left" sx={{padding: '6px 16px 6px 16px'}}>{Restaurant?.name}</TableCell>
