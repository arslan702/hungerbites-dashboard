...
const collectedurl = resourceUrl('invoice/overdue')
...
const TotalOverdue = ({ value }) => {
    ...
    const handleEditClick = async() => {
        await apiPut(`invoice/${currentRowId}`, {status: 'collected'});
        setOpen(null);
        await fetchInvoices();
    };
    ...
    const currentRows = invoice?.slice(start, end);
